package live.uwapps.mpvkt.ui.home
...
import live.uwapps.mpvkt.ui.player.audioExtensions
import live.uwapps.mpvkt.ui.player.imageExtensions
import live.uwapps.mpvkt.ui.player.videoExtensions
import live.uwapps.mpvkt.ui.theme.spacing
import live.uwapps.mpvkt.ui.utils.FilesComparator
import live.uwapps.mpvkt.ui.utils.LocalBackStack
import live.uwapps.mpvkt.ui.util.PlayerLauncher
        ...
        onNavigate = { newFile ->
          if (fileManager.isFile(newFile)) {
            if (subtitlesPreferences.autoLoadExternal.get()) {
              ...
              PlayerLauncher.playFile(newFile.getFullPath(), context)
            }
            return@FilePicker
          }
