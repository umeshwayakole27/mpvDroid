package com.uw.mpvDroid.ui.browser.networkstreaming.proxy

import android.util.Log
import com.uw.mpvDroid.domain.network.NetworkConnection
import com.uw.mpvDroid.ui.browser.networkstreaming.clients.NetworkClient
import com.uw.mpvDroid.ui.browser.networkstreaming.clients.NetworkClientFactory
    ...
    return runBlocking {
      try {
        when (streamInfo.client) {
          is com.uw.mpvDroid.ui.browser.networkstreaming.clients.SmbClient -> {
            getFileSizeSMB(streamInfo)
          }

          is com.uw.mpvDroid.ui.browser.networkstreaming.clients.FtpClient -> {
            getFileSizeFTP(streamInfo)
          }

          is com.uw.mpvDroid.ui.browser.networkstreaming.clients.WebDavClient -> {
            val webDavClient =
              streamInfo.client as com.uw.mpvDroid.ui.browser.networkstreaming.clients.WebDavClient
            ...
            val ftpClient =
              streamInfo.client as? com.uw.mpvDroid.ui.browser.networkstreaming.clients.FtpClient
