...
import com.uw.mpvDroid.presentation.components.ConfirmDialog
    ...
    Scaffold(
      ...
      ProvidePreferenceLocals {
        ...
        Column(
          ...
          val mpvDroidDatabase = koinInject<MpvDroidDatabase>()
          Preference(
          ...
          if (isConfirmDialogShown) {
            ConfirmDialog(
              ...
              onConfirm = {
                scope.launch(Dispatchers.IO) { mpvDroidDatabase.videoDataDao() }
